...
export default function Learn() {
    ...
    function setupSampleProjectCard(data) {
        return (
            <>
                <div style={{width: "100%", height: "fit-content", display: "flex", flexWrap: "wrap", border: "#FFDD00 solid 3px", borderRadius: "5px"}}>
                    <img className='me-3 my-1 ms-1' style={{width: "150px", height:"90px", borderRadius: "5px", objectFit: "cover"}} src={data.image} alt="Project" />
                    ...
                    <>
                        <Container>
                            ...
                            <Row style={{width: "100%", height: "fit-content", display: "flex", flexWrap: "wrap"}}>
                                <Col>
                                    <img className='mx-auto' style={{objectFit: "cover", width: "350px", height: "150px"}} src={item.image} alt="Tutorial" />
                                </Col>
