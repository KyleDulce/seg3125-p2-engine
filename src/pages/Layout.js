    ...
    return (
        <>
            <div style={{backgroundColor: "#ff6666"}}>
                <p className="my-0"><b>These pages are for a school assignment. This is not a real company and there are no real services!
                    Refer to my home page for information about me <a href="https://kyledulce.github.io/">here.</a>
                </b></p>
            </div>
            <Navbar className='py-0' expand="md" style={navBarStyle}>
                <Container className="mx-0 w-100" style={{maxWidth: "100%"}}>
                    <Navbar.Brand href="/seg3125-p2-engine" className="ml-1 my-0">
                        <img src={logo} alt="logo" style={Object.assign({height: "5rem"}, logoStyle)}/>
                    </Navbar.Brand>
                        ...
                        <Nav>
                            ...
                            {isShown && (
                                <Row className='my-auto mx-2'>
                                    ...
                                    <Col>
                                        <Button className='normalText whiteColor blackBackground bigFont mx-2 accentOutlineButton'>Search</Button>
                                    </Col>
                                </Row>
                            )}
                            {!isShown && (
